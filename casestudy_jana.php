...
<body>
    ...
    <section id="jana">
        ...
        <div class="cs_left">
            ...
            <img src="images/jana1.jpg" alt="Mockup of homepage">
            <div class="cs_text">
                <h4>services</h4>
                    <ul class="white">
            ...
            <img src="images/jana7.jpg"alt="stylescapes">
            <div class="cs_text">
                <h4>client</h4>
            ...
            <img src="images/jana4.jpg"alt="responsive webdesign">
            <div class="cs_text">
                <h4>challenge</h4>
            ...
            <img src="images/jana3.jpg"alt="design of services">
            <div class="cs_text">
                <h4>process</h4>
            ...
            <div class="cs_text">
                ...
                <p>We built a website reflecting Jana’s original approach - aiming for different target groups. We created content that attracts female au pairs, job seekers,
                 exposition exhibitors and addressed them individually in clickable sections. The final design is straightforward and modern at the same time. Special emphasis 
                 was placed on testimonials to build up confidence from new clients and to give them a clear overview of services.</p>
                <br><br><br>
                ...
                <br><br>
                <a href="http://jananovotna.co/" target="_blank"><p><img src="images/arrow_w.svg" alt="pointer" class="arrow">  view project</p></a>
            </div>
            
            <!-- <img src="images/boom5.jpg" alt=""> -->
            <img src="images/jana5.jpg" alt="tablet mockups">
        ...
        <div class="cs_right">
            ...
            <div class="cs_text">
            <h4>solution</h4>
                <p>We built a website reflecting Jana’s original approach - aiming for different target groups. We created content that attracts female au pairs, job seekers, exposition exhibitors 
                and addressed them individually in clickable sections. The final design is straightforward and modern at the same time. Special emphasis was placed on testimonials to build up 
                confidence from new clients and to give them a clear overview of services.</p>
            </div>
            <div class="cs_text">
            <a href="https://www.youtube.com/watch?v=0lqsZTcGjR4" target="_blank"><h4><span class="iconify" data-inline="false" data-icon="clarity:music-note-solid" style="color: #fff;"></span>Jason Mraz</h4></a>
            <p>I discovered listening to music helps me focus on coding. I have return to my favourite artist: Jason Mraz.</p>    
