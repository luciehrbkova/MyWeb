    ...
    <section id="jana">
        ...
        <div class="cs_left">
            ...
            <div class="cs_text">
                ...
                <br><br>
                <h4>zadání</h4>
                <p>Vytvoření webové stránky pro Janu, která se nedávno rozhodla začít podnikat jako překladatelka a lektorka němčiny. Web by měl prezenovat informace 
            ...
            <div class="cs_text">
                ...
                <p>Postavili jsme web, který odráží Janin originální přístup - mířit na různé cílové skupiny uživatelů a vytvořili jsme obsah atraktivní pro každého zvlášť. 
                    Finální design je decentní a moderní zároveň. Pro zvýšení důvěry nových zákazníků a bližšího přehledu o jejích službách jsem se zdůraznili reference jejích 
                    předchozích spokojených zákazníků.</p>
                <br><br><br>
        ...
        <div class="cs_right">
            ...
            <div class="cs_text">
                <a href=""><h4><span class="iconify" data-inline="false" data-icon="clarity:music-note-solid" style="color: #fff;"></span>Jason Mraz</h4></a>
                <p>Hudba mi pomáhá udržet se během kódování v rytmu. Tento projekt mi zpříjemnil Jason Mraz.</p>  
            </div>
            <div class="cs_text">
                <a href="http://jananovotna.co/" target="_blanc"><p> <img src="../images/arrow_w.svg" alt="arrow" class="arrow">  zobrazit projekt</p></a>
