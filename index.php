...
<body>
    ...
    <section id="home" class="home">
        ...
        <div class="left background_white" id="homepageBackground">
            ...
            <div class="landing_img" data-aos="fade-right">
                <img src="images/arrow.svg" alt="arrow" class="arrow" id="arrow">
        ...
        <div class="right background_black" id="landing_right"> 
            ...
            <div class="value" id="blueValue">
                <img src="images/rect.png" alt="blue square">
    ...
    <section class="about" id="about">
        ...
        <img src="images/luca.png" alt="Lucie's portrait" class="luca">
        ...
        <div class="left background_white">
            ...
            <!-- ONLY MOBILE -->
                ...
                <div class="project_card">
                    <a href="casestudy_helena.php"><img src="images/pr_helena.jpg" alt="Helena Kmochova's website" class="cover" id="cover2"></a> 
    ...
    <section class="reference" id="reference">
        <div class="left background_white">
            ...
            <div class="refcard" id="reference_card_3">
                <p class="black">Lucie was recommended to me and I must admit that she exceeded my expectations. She helped me to understand many interesting facts, such as how important is to address how the site will be perceived by the users and what are their interests.
        ...
        <div class="reference_playground" id="pl_blu">
            <img src="images/rect.png" alt="blue square"  id="ctverec_ref">
        </div>
        ...
        <div class="left background_white">
            ...
            <div class="contact_data">
                ...
                <div class="socmedia">
                    ...
                    <a href="https://www.linkedin.com/in/luciehrbkova/"><img src="images/linked.png" alt="linked icon" id="link"></a>
                </div>
            </div>
        </div>
        <div class="right background_black">
