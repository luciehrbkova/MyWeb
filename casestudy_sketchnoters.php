...
<body>
    ...
    <section id="sketchnoters">
        ...
        <div class="cs_left">
            ...
            <img src="images/sketchnoters1.jpg" alt="design for Sketchnoters">
            <div class="cs_text">
                <h4>sercices</h4>
                <ul class="white">
                    <li>UI/UX</li>
            ...
            <img src="images/sketchnoters5.jpg" class="cs_image_pc_no" alt="mobile designs">
            <div class="cs_text">
                <h4>challenge</h4>
            ...
            <img src="images/sketchnoters3b.jpg" alt="Landing page design">
            <img src="images/sketchnoters4.png" alt="Sketchnoters team presentation">
            <div class="cs_text">
                <h4>solution</h4>
                ...
                <br><br><br>
                <a href="http://thesketchnoters.com/" target="_blank"><p><img src="images/arrow_w.svg" alt="pointer" class="arrow">  view project</p></a>
            </div>
            
            <img src="images/sketchnoters6.jpg" class="cs_image_pc_no" alt="mobile design">
            <div class="cs_image_pc_only">
                <img src="images/sketchnoters5.jpg" alt="handmade illustrations">
                <img src="images/sketchnoters6.jpg" alt="contrast in colors">
            </div>
        </div>
        <!-- right -->
        <div class="cs_right">
